...
const ArticlesPlan = () => {
  ...
  const createSession = async (priceId: number) => {
  ...
  return (
    <Container>
      <CardsContainer>
            ...
            >
              <CardHeader
                style={{ backgroundColor: backgroundColors['lightBlue'] }}
              >
                <PriceCircle>
                  <PriceText>{amountvariable / 100}</PriceText>
                </PriceCircle>
              </CardHeader>
              <Card.Body>
                ...
                <Button
                  variant="primary"
                  className="mt-2"
                  onClick={() => createSession(amountvariable)}
                >
                  Buy now
                </Button>
              </Card.Body>
